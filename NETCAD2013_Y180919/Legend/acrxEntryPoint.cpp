...
// General defines
#define szRDS _RXST("")
#define ARX_COMMAND L"Dynamic Legend"

///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// Forward declarations
extern BOOL ReadINIFile();                // ReadINI.cpp
extern void Command_Legend();							// LegendCommand.cpp

////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// Class name       : CDwgTools_NET_DynamicLegend
// Description      : The one and only application class
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
class CDwgTools_NET_DynamicLegend : public AcRxArxApp
{
  // Public section
public:

  // Default constructor
  CDwgTools_NET_DynamicLegend() : AcRxArxApp() { }
  ...
  static void DwgTools_NET_Legend(void) { if (isAcad2011(ARX_COMMAND) && ReadINIFile()) Command_Legend(); }
};

///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// This will implement the class as the Entry Point
IMPLEMENT_ARX_ENTRYPOINT(CDwgTools_NET_DynamicLegend)

///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// Command registrations
ACED_ARXCOMMAND_ENTRY_AUTO(CDwgTools_NET_DynamicLegend, DwgTools, _NET_Legend, NDL,	ACRX_CMD_MODAL | ACRX_CMD_USEPICKSET, NULL)
