...
//-----------------------------------------------------------------------------
//- Dimensions.cpp : Initialization functions
//-----------------------------------------------------------------------------
#include "StdAfx.h"
#include "resource.h"
#include <afxdllx.h>
...
AC_IMPLEMENT_EXTENSION_MODULE(DimensionsDLL)
...
#ifdef NEVER
AFX_EXTENSION_MODULE DimensionsExtDLL ={ NULL, NULL } ;
#endif
...
BOOL WINAPI DllMain (HINSTANCE hInstance, DWORD dwReason, LPVOID lpReserved) {
	...
	if ( dwReason == DLL_PROCESS_ATTACH ) {
		...
		DimensionsDLL.AttachInstance (hInstance) ;
		InitAcUiDLL () ;
	} else if ( dwReason == DLL_PROCESS_DETACH ) {
		DimensionsDLL.DetachInstance () ;
	}
	return (TRUE) ;
}
