...
// General defines
#define szRDS _RXST("")
#define ARX_COMMAND _T("Text")

///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// Forward declarations
extern BOOL ReadINIFile();  // ReadINI.cpp
extern void Command_Text(); // TextCommand.cpp

////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// Class name       : CDXFTransApp
// Description      : The one and only application class
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
class CDwgTools_NET_Text : public AcRxArxApp
{
  // Public section
public:

  // Default constructor
  CDwgTools_NET_Text() : AcRxArxApp() { }
  ...
  static void DwgTools_NET_Text(void) { if (isAcad2011(ARX_COMMAND) && ReadINIFile()) Command_Text(); }
};

///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// This will implement the class as the Entry Point
IMPLEMENT_ARX_ENTRYPOINT(CDwgTools_NET_Text)

///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// Command registrations
ACED_ARXCOMMAND_ENTRY_AUTO(CDwgTools_NET_Text, DwgTools, _NET_Text, NT,	ACRX_CMD_USEPICKSET | ACRX_CMD_MODAL, NULL)
