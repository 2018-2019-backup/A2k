...
//-----------------------------------------------------------------------------
//- MoveOnOff.cpp : Initialization functions
//-----------------------------------------------------------------------------
#include "StdAfx.h"
#include "resource.h"
#include <afxdllx.h>
...
AC_IMPLEMENT_EXTENSION_MODULE(MoveOnOffDLL)
...
#ifdef NEVER
AFX_EXTENSION_MODULE MoveOnOffExtDLL ={ NULL, NULL } ;
#endif
...
BOOL WINAPI DllMain (HINSTANCE hInstance, DWORD dwReason, LPVOID lpReserved) {
	...
	if ( dwReason == DLL_PROCESS_ATTACH ) {
		...
		MoveOnOffDLL.AttachInstance (hInstance) ;
		InitAcUiDLL () ;
	} else if ( dwReason == DLL_PROCESS_DETACH ) {
		MoveOnOffDLL.DetachInstance () ;
	}
	return (TRUE) ;
}
