...
// General defines
#define szRDS _RXST("")
#define ARX_COMMAND _T("Attribute")

///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// Forward declarations
extern BOOL ReadINIFile();                // ReadINI.cpp
extern void Command_Properties();         // PropertiesDlg.cpp
...
public:
  ...
  static void DXFTrans_NET_Attribute(void) { if (isAcad2011(ARX_COMMAND) && ReadINIFile()) Command_Properties(); }
};
...
ACED_ARXCOMMAND_ENTRY_AUTO(CDXFTransApp, DXFTrans, _NET_Attribute, NAA,  ACRX_CMD_USEPICKSET | ACRX_CMD_REDRAW, NULL)
